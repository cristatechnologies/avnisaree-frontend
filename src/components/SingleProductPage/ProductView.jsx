          ...
          >
            <div className="w-full">
              <div className="w-full md:h-[600px] h-[350px] border border-qgray-border flex justify-center items-center overflow-hidden relative mb-3 relative">
                ...
                />
                {product.offer_price && (
                  <div className="w-[80px] h-[80px] rounded-full primary-bg text-white flex justify-center items-center text-xl font-medium absolute left-[30px] top-[30px]">
              ...
              <div className="flex gap-2 flex-wrap">
                <div
                  ...
                  className="w-[110px] h-[110px] p-[15px] border border-qgray-border cursor-pointer relative bg-white"
                >
                  <Image
                    layout="fill"
                    objectFit="scale-down"
            ...
            <div className="product-details w-full mt-10 lg:mt-0">
              ...
              <div data-aos="fade-up" className="message-btn">
                <button
                  ...
                  className="flex px-5 py-2 primary-bg text-white items-center space-x-2.5"
                  type="button"
                >
                  <span>
                    <svg
