        ...
        <div className="main-wrapper-card relative">
          ...
          >
                  ...
                  >
                    <span>
                      <FontAwesomeCom
                        icon={"fa fa-link"}
                        className={
                          "w-9 h-9 text-white bg-[var(--primary-color)]"
                        }
                      />
                    </span>
                  </Link>
            ...
            <div className="product-card-details px-[30px] pb-[30px] relative pt-2">
              ...
              <p className="price">
                ...
                {offerPrice && (
                  <span
                    suppressHydrationWarning
                    className="offer-price text-[var(--primary-color)] font-600 text-[18px] ml-2"
                  >
                    <CheckProductIsExistsInFlashSale
                      id={datas.id}
                      price={offerPrice}
            ...
            <div className="quick-access-btns flex flex-col space-y-2">
              <button
                className={
                  "group-hover:left-16 -left-10 absolute  bottom-40  transition-all ease-in-out"
                }
              ...
              {!arWishlist ? (
                <button
                  className={
                    "group-hover:left-28 -left-10 absolute bottom-40  transition-all duration-300 ease-in-out"
                  }
                  type="button"
                ...
                <button
                  className={
                    "group-hover:left-44 -left-10 absolute bottom-40  transition-all duration-300 ease-in-out"
                  }
                  type="button"
              ...
              <button
                className={
                  "group-hover:left-40 absolute  bottom-40  -left-10 transition-all duration-500 ease-in-out"
                }
                type="button"
